...
div(
  ...
  # hello
  div(
    class = "g-col-12 g-col-md-4 align-self-center",
    accordeon_code(
      title = "> PICTURE",
      body = img(src = "image/6_SESAN_017carre3.png",class="img-fluid rounded"),
      id = "photo"
      )
),
# empty line
empty_line(size = 1),
div(
    class = "g-col-12  g-col-md-8 justify-content-left",
    accordeon_code(
      title = "> CONTACT",
      body = body_contact,
      id = "contact")
